...
const PLANS: PlanDef[] = [
  {
    ...
    monthlyPrice: 0,
    features: [
      { text: "35+ outils de trading", icon: Zap },
      { text: "Journal illimité", icon: FileText },
      { text: "Analytics de base", icon: BarChart3 },
      { text: "Chat communautaire", icon: MessageCircle },
    ],
    cta: "Actuel",
  },
  {
    ...
    vip: true,
    features: [
      { text: "Tout Free +", icon: Check },
      { text: "AI Coach avancé", icon: Brain },
      { text: "Filtres avancés", icon: Filter },
      { text: "Export PDF illimité", icon: FileText },
      { text: "Indicateurs TradingView exclusifs", icon: Star },
      { text: "Analyses macro privées", icon: Globe },
      { text: "War Room privée", icon: Lock },
      { text: "Support prioritaire", icon: Shield },
      { text: "Accès API", icon: Code },
      { text: "Badge VIP doré", icon: Crown },
      { text: "Badges exclusifs", icon: Award },
    ],
    cta: "Passer à VIP",
  },
];
...
const COMPARISON = [
  { feature: "Outils de trading", free: "35+", vip: "35+" },
  { feature: "Journal de trades", free: true, vip: true },
  { feature: "Analytics de base", free: true, vip: true },
  { feature: "Chat communautaire", free: true, vip: true },
  { feature: "AI Coach avancé", free: false, vip: true },
  { feature: "Filtres avancés", free: false, vip: true },
  { feature: "Export PDF illimité", free: false, vip: true },
  { feature: "Support prioritaire", free: false, vip: true },
  { feature: "Badges exclusifs", free: false, vip: true },
  { feature: "Indicateurs TradingView", free: false, vip: true },
  { feature: "Analyses macro privées", free: false, vip: true },
  { feature: "War Room privée", free: false, vip: true },
  { feature: "Accès API", free: false, vip: true },
