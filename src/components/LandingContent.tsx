...
function CounterCard({ stat, visible }: { stat: { num: number; prefix: string; suffix: string; decimals: number; label: string }; visible: boolean }) {
  ...
  return (
    <div className="p-4 sm:p-6 rounded-2xl bg-white border border-gray-100 shadow-sm">
      <div className="text-2xl sm:text-3xl font-black bg-gradient-to-r from-blue-600 to-cyan-500 bg-clip-text text-transparent mb-1">{display}</div>
      ...
      >
        ...
        >
          <div className={`${animBase} ${isVisible(0) ? animIn : animOut} max-w-7xl mx-auto w-full`}>
            <div className="hidden sm:block absolute top-20 right-0 w-[600px] h-[600px] bg-gradient-to-bl from-blue-100/60 via-cyan-50/40 to-transparent rounded-full blur-3xl pointer-events-none" />
            <div className="hidden sm:block absolute bottom-0 left-0 w-[400px] h-[400px] bg-gradient-to-tr from-violet-100/30 to-transparent rounded-full blur-3xl pointer-events-none" />
            ...
            <div className="relative flex flex-col lg:flex-row items-center gap-12 lg:gap-8">
              ...
              <div className="flex-1 w-full lg:w-auto max-w-2xl">
                <div className="relative animate-hero-float">
                  ...
                  <div className="hidden sm:block absolute -top-3 -right-3 sm:-top-5 sm:-right-6 p-3 sm:p-4 rounded-xl bg-white/95 backdrop-blur-sm border border-gray-200 shadow-xl">
                    <div className="flex items-center gap-3">
                ...
                <div className="mt-6 mx-auto max-w-md p-4 rounded-2xl bg-white/70 backdrop-blur-md border border-gray-200/60 shadow-lg">
                  ...
                  <p className="text-sm italic text-gray-600 leading-relaxed">&ldquo;MarketPhase a transform&eacute; mon trading. Je vois enfin mes erreurs.&rdquo;</p>
                  <p className="mt-1.5 text-xs font-medium text-gray-400">&mdash; Thomas R., Forex Trader</p>
                </div>
              </div>
            </div>
          </div>
        ...
        >
          <div className={`${animBase} ${isVisible(2) ? animIn : animOut} max-w-5xl mx-auto w-full`}>
            <div className="text-center mb-12">
              <h2 className="text-2xl sm:text-4xl lg:text-5xl font-black text-gray-900 mb-4">
                {t("landing_heroTitle1")}{" "}
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-3 sm:gap-8 text-center">
              {[
                ...
                <div key={s.label} className="p-4 sm:p-8 rounded-2xl bg-gray-50 border border-gray-100 hover:border-blue-200 hover:shadow-lg transition-all">
                  <span className="text-3xl sm:text-5xl lg:text-6xl font-black bg-gradient-to-r from-blue-600 to-cyan-500 bg-clip-text text-transparent">{s.value}</span>
        ...
        >
          <div className={`${animBase} ${isVisible(6) ? animIn : animOut} max-w-7xl mx-auto w-full`}>
            <div className="text-center mb-8 sm:mb-10">
              ...
              <h2 className="text-2xl sm:text-4xl lg:text-5xl font-black text-gray-900">{t("landing_featuresTitle")}</h2>
            </div>
        ...
        >
          <div className={`${animBase} ${isVisible(8) ? animIn : animOut} max-w-5xl mx-auto w-full text-center ${isMobile ? "" : "pt-16 pb-8"}`}>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-5 max-w-4xl mx-auto mb-14 px-2">
              {[
                { name: t("landing_testimonial1Name"), role: t("landing_testimonial1Role"), style: t("landing_testimonial1Style"), text: t("landing_testimonial1Text"), grad: "from-blue-500 to-cyan-400" },
                { name: t("landing_testimonial2Name"), role: t("landing_testimonial2Role"), style: t("landing_testimonial2Style"), text: t("landing_testimonial2Text"), grad: "from-emerald-500 to-teal-400" },
                { name: t("landing_testimonial3Name"), role: t("landing_testimonial3Role"), style: t("landing_testimonial3Style"), text: t("landing_testimonial3Text"), grad: "from-purple-500 to-pink-400" },
              ].map((tm) => (
                <div key={tm.name} className="relative p-5 sm:p-6 rounded-2xl bg-white border border-gray-100 shadow-sm text-left hover:shadow-lg hover:-translate-y-1 transition-all duration-300">
                  <div className="flex gap-0.5 mb-3">
                    {[...Array(5)].map((_, i) => (
                      <Star key={i} className="w-4 h-4 fill-amber-400 text-amber-400" />
                    ))}
                  </div>
                  <p className="text-gray-600 text-xs sm:text-sm italic leading-relaxed mb-4">&ldquo;{tm.text}&rdquo;</p>
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      <p className="text-sm font-bold text-gray-900">{tm.name}</p>
                      <p className="text-xs text-gray-400">{tm.role} &middot; {tm.style}</p>
                    </div>
                  </div>
                </div>
              ))}
        ...
        >
          <div className={`${animBase} ${isVisible(9) ? animIn : animOut} ${isMobile ? "" : "pt-20 pb-8"}`}>
            ...
            <div className="max-w-4xl mx-auto px-4 text-center mb-16">
              <h2 className="text-2xl sm:text-4xl lg:text-5xl font-black mb-4 sm:mb-6 text-gray-900">
